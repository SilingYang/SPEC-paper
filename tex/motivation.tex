...
However, building such an efficient system entails three significant challenges:}
...
In \S\ref{exp:prefetch}, we empirically demonstrate that this history-based heuristic significantly underperforms our method in both prefetch precision and I/O reduction under the same budget.
}
%\zrdnew{
