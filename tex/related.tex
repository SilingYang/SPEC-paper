...
\label{related}
\noindent
\zrdnew{\textbf{Data prefetching for LLM inference.}
...
InfiniGen~\cite{infinigen-osdi24} introduces speculative prefetching to hide latency, but it targets the decoding phase and relies on invasive model weight modifications and extra rehearsal computation.
In contrast, \pname{} targets the prefill phase and employs a heuristic based on similarity with negligible overhead. 
